...
public class EditRecyclerAdapter extends RecyclerView.Adapter<EditRecyclerAdapter.ViewHolder> implements Filterable{
    ...
    EditRecyclerAdapter(List<Cadet> cadetList) {
